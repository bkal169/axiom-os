...
export function SiteMap({ projectId }: Props) {
    ...
    return (
        ...
        >
            <div ref={mapContainer} style={{ height: 420, width: "100%", borderRadius: 8, overflow: "hidden", border: "1px solid var(--c-border)" }} />

            <div className="axiom-text-11-dim" style={{ marginTop: 8 }}>
                📍 Mapbox Engine: Rendering 3D elevation and building extrusions for {project.municipality || "Site Context"}.
            </div>
        </Card>
    );
}
