...
import { ArrowRight, ChevronRight, Layers, Map as MapIcon, Zap, Smartphone } from 'lucide-react';
        ...
        <div className="axiom-landing-wrapper" style={{ backgroundColor: '#0A0A0A', color: '#ECECEC', minHeight: '100vh', fontFamily: 'Inter, sans-serif' }}>
            ...
            <nav style={{ padding: '24px 48px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #222' }}>
                ...
                <div style={{ display: 'flex', gap: 32 }}>
                    <a href="#features" style={{ color: '#888', textDecoration: 'none', transition: '0.2s' }}>Features</a>
                    <a href="#synergy" style={{ color: '#888', textDecoration: 'none', transition: '0.2s' }}>The Synergy</a>
                    <a href="#beta" style={{ color: '#D4A843', textDecoration: 'none', fontWeight: 600 }}>Apply for Beta</a>
                </div>
            </nav>
