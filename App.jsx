...
const SUPA_URL = _ENV.VITE_SUPABASE_URL || localStorage.getItem("axiom_supa_url") || "";
const SUPA_KEY = _ENV.VITE_SUPABASE_ANON_KEY || localStorage.getItem("axiom_supa_key") || "";
